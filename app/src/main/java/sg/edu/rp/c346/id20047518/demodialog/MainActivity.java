package sg.edu.rp.c346.id20047518.demodialog;
        ...
        btnExercise3.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myBuilder.setPositiveButton( "OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user
                        int message = Integer.parseInt( etInput2.getText().toString() ) + Integer.parseInt( etInput3.getText().toString() );

                        // Set the text to the TextView
                        tvExercise3.setText( String.valueOf( message ) );
                    }
                } );
                myBuilder.setNegativeButton( "CANCEL", null );
                AlertDialog myDialog = myBuilder.create();
